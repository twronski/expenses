...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { amount: @budget.amount, category_id: @budget.category_id, month: @budget.month } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { amount: @budget.amount, category_id: @budget.category_id, month: @budget.month } }
